...
input_text = "Меня зовут Иванов Иван Иванович. Мой контактный телефон: +7 (900) 123-45-67, адрес электронной почты: ivanov.test@example.com. Кадастровый номер объекта недвижимости: 36:25:0301001:1234. Объект находится в Воронежской области. Координаты GPS местоположения проблемы: 51.6755, 39.2089."
